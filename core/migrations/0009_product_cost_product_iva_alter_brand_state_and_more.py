# Generated by Django 5.0.6 on 2024-05-26 00:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0008_alter_product_brand_alter_product_categories_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='brand',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product', to='core.brand', verbose_name='Marca'),
        ),
        migrations.AlterField(
            model_name='product',
            name='categories',
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=django.utils.timezone.now, verbose_name='Fecha Caducidad'),
        ),
        migrations.AlterField(
            model_name='product',
            name='line',
            field=models.CharField(choices=[('RS', 'Rio Store'), ('FS', 'Ferrisariato'), ('CS', 'Comisariato')], default='CS', max_length=2, verbose_name='Linea'),
        ),
        migrations.AlterField(
            model_name='product',
            name='state',
